...
export class SpoonacularService {
    ...
    parseDirection(recipe_id) {
        ...
        let headers = new HttpHeaders().set("X-Mashape-Key", "AAaxAV6fA9mshBFSpgoqjaBwkmKCp1lp4XCjsnyhrze9WCDm3Q").set("Accept", "application/json");
        ...
        this.http.get(this.getRecipesURL, { params: params, headers: headers })
            ...
            .mergeMap((recipes) => {
                return Observable.forkJoin(
                    recipes.map((recipe) => {
                        let headersNew = new HttpHeaders().set("X-Mashape-Key", "AAaxAV6fA9mshBFSpgoqjaBwkmKCp1lp4XCjsnyhrze9WCDm3Q").set("Accept", "application/json");
